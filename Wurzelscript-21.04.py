...
def ClearScreen():
    ...
    if BesseresDesign == True:
        print ("Erfolg: Besseres Design installiert!")
...
if input(" > Developer-Tools installieren? (.NET5/Java/VSCode usw) [y, n]: ") == "y":
    ...
    #.NET5
    os.system("wget https://packages.microsoft.com/config/ubuntu/21.04/packages-microsoft-prod.deb -O packages-microsoft-prod.deb")
...
if DashToPanel == True:
    print()
    if input("Jetzt neustarten (empfohlen) [y, n]: ") == "y":
